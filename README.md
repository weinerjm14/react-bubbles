...
It is used to authenticate with a server to get to protected routes

What steps can you take in your web apps to keep your data secure?

so far we have learned about client side auth which is involves using an API with a log in endpoint, storing the authentication token in local storage, sending that token with every call that goes to a non public route, and using private routes to force authentication when someone is trying to view data we want protected

Describe how web servers work.

I normally explain this to my clients as a server is where your website lives-- kind of like the neighbour hood your house is in... your url is like your street address. when some one puts your url in their browser--which is working something like a gps and a car here--- it reaches out to get everything it needs to show you the website from the server. The server holds all the information about your house, the people who use your house if you have user accounts, and sends it to anyone looking to visit, over the internet of course!
